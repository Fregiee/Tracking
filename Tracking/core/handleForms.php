...
if (isset($_POST['insertNewBranchBtn'])) {
	...
	if (!empty($address) && !empty($developer) && !empty($contact_number)) {
		$insertABranch = insertABranch($pdo, $address, $developer, 
...
if (isset($_POST['updateBranchBtn'])) {
	...
	if (!empty($address) && !empty($developer) && !empty($contact_number)) {
		...
		$updateBranch = updateBranch($pdo, $address, $developer, $contact_number, 
